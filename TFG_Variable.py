...
#######################################################
print('<<=======================    Variable:Lifecycles, naming, and watching  =======================>>')
'''
...
# By default, variables in models will acquire unique variable names automatically,
# so you don't need to assign them yourself unless you want to.
...
print(k)
# Because tf.config.set_soft_device_placement is turned on by default,
...
for element in dataset.as_numpy_iterator(): #Returns an iterator which converts all elements of the dataset to numpy.
